...
public class AmbienceEventHandler
{
    //Static references
    public static AmbienceEventHandler instance;
    ...
    public void tick(TickEvent.ClientTickEvent event) {
        ...
        for(CustomSoundSlot slot : soundsList) {
            if(!handler.isSoundPlaying(slot.getMusicInstance()) || !mc.world.loadedTileEntityList.contains(slot.getOwner())) {
    ...
    public void playMusic(AmbienceTileEntity tile, String source) {
        ...
        handler.playSound(playingMusic);
    ...
    public void stopMusic(CustomSoundSlot soundSlot, String source) {
        ...
        if(soundSlot.getOwner().data.getFadeOut() != 0f && !soundSlot.getOwner().data.isUsingDelay())
            ...
            handler.stopSound(soundSlot.getMusicInstance());
