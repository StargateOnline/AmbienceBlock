...
public class BoundsTab extends AbstractTab {
    ...
    CheckboxButton isGlobal = new CheckboxButton(getNeighbourX(buttonBounds), getRowY(0), 20 + font.getStringWidth("Global"), 20, "Global", false);
    ...
    public void setFieldFromData(AmbienceTileEntityData data) {
        ...
        offsetX.setText(String.valueOf(pos.x));
        offsetY.setText(String.valueOf(pos.y));
        offsetZ.setText(String.valueOf(pos.z));
    }
