package com.sekai.ambienceblock.client.gui.event;
...
public class WidgetGuiScreenEvent extends GuiScreenEvent
{
    private Screen gui;
    public WidgetGuiScreenEvent(Screen gui)
    {
        super(gui);
        this.gui = gui;
    }
    ...
    public static class InitGuiEvent extends WidgetGuiScreenEvent
    {
        ...
        public InitGuiEvent(Screen gui) {
            super(gui);
        }
         ...
         */
        @Cancelable
        public static class Pre extends WidgetGuiScreenEvent.InitGuiEvent
        {
         ...
         */
        public static class Post extends WidgetGuiScreenEvent.InitGuiEvent
        {
    ...
    public static class DrawWidgetGuiScreenEvent extends WidgetGuiScreenEvent
    {
        private final int mouseX;
        private final int mouseY;
        private final float renderPartialTicks;

        public DrawWidgetGuiScreenEvent(Screen gui, int mouseX, int mouseY, float renderPartialTicks)
        {
            super(gui);
            this.mouseX = mouseX;
            this.mouseY = mouseY;
         ...
         */
        @Cancelable
        public static class Pre extends DrawWidgetGuiScreenEvent
        {
         ...
         */
        public static class Post extends DrawWidgetGuiScreenEvent
        {
     ...
     */
    public static class BackgroundDrawnEvent extends WidgetGuiScreenEvent
    {
     ...
     */
    @Cancelable
    public static class PotionShiftEvent extends WidgetGuiScreenEvent
    {
    ...
    public static class ActionPerformedEvent extends WidgetGuiScreenEvent
    {
         ...
         */
        @Cancelable
        public static class Pre extends WidgetGuiScreenEvent.ActionPerformedEvent
        {
    ...
    public static abstract class MouseInputEvent extends WidgetGuiScreenEvent
    {
    ...
    public static abstract class KeyboardKeyEvent extends WidgetGuiScreenEvent
    {
    ...
    public static class KeyboardCharTypedEvent extends WidgetGuiScreenEvent
    {
