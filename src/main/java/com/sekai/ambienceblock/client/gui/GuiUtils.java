...
import com.sekai.ambienceblock.util.Matrix4f;
import com.sekai.ambienceblock.util.MatrixStack;
...
public class GuiUtils
{
                                        ...
                                        int backgroundColor, int borderColorStart, int borderColorEnd, FontRenderer font)
    {
        if (!textLines.isEmpty())
        {
            ...
            for (int lineNumber = 0; lineNumber < textLines.size(); ++lineNumber)
            {
                ...
                if (line != null)
                    //font.drawString(line, (float)tooltipX, (float)tooltipY, -1, true, textLocation, renderType, false, 0, 15728880);
                    font.drawString(line, (float)tooltipX, (float)tooltipY, 0, true);
    ...
    public static void drawInscribedRect(int x, int y, int boundsWidth, int boundsHeight, int rectWidth, int rectHeight, boolean centerX, boolean centerY)
    {
        ...
        Gui.drawScaledCustomSizeModalRect(x, y, boundsWidth, boundsHeight, 0,0, rectWidth, rectHeight, rectWidth, rectHeight);
    }
}
