...
public class PriorityTab extends AbstractTab {
    public TextInstance textPriority = new TextInstance(getBaseX(), getRowY(0) + getOffsetY(font.FONT_HEIGHT), 0xFFFFFF, I18n.format("gui.ambienceblock.priority") + " :", font);
    public TextFieldWidget priority = new TextFieldWidget(font, getNeighbourX(textPriority), getRowY(0), 40, 20, "name");
    public TextInstance textChannel = new TextInstance(getNeighbourX(priority), getRowY(0) + getOffsetY(font.FONT_HEIGHT), 0xFFFFFF, I18n.format("gui.ambienceblock.channel") + " :", font);
