...
import com.sekai.ambienceblock.client.gui.ambience.ChooseSoundGUI;
...
{
    public TextInstance textSoundName = new TextInstance(getBaseX(), getRowY(0) + getOffsetY(font.FONT_HEIGHT), 0xFFFFFF, I18n.format("gui.ambienceblock.music_id") + " :", font);
    ...
    public Button soundButton = guiRef.addButton(new Button(getNeighbourX(soundName), getRowY(0) + getOffsetY(20), 20, 20, "...", button -> {
        Minecraft.getMinecraft().displayGuiScreen(new ChooseSoundGUI(this.guiRef, soundName));
    }));

    public TextInstance textVolume = new TextInstance(getBaseX(), getRowY(1) + getOffsetY(font.FONT_HEIGHT), 0xFFFFFF, I18n.format("gui.ambienceblock.volume") + " :", font);
    public TextFieldWidget soundVolume = new TextFieldWidget(font, getNeighbourX(textVolume), getRowY(1), 40, 20, "name");

    public TextInstance textPitch = new TextInstance(getNeighbourX(soundVolume), getRowY(1) + getOffsetY(font.FONT_HEIGHT), 0xFFFFFF, I18n.format("gui.ambienceblock.pitch") + " :", font);
    ...
    public CheckboxButton shouldFuse = new CheckboxButton(getBaseX(), getRowY(2), 20 + font.getStringWidth("Should fuse"), 20, "Should fuse", false);
    public CheckboxButton useDelay = new CheckboxButton(getBaseX(), getRowY(3), 20 + font.getStringWidth("Using delay"), 20, "Using delay", false);
    public CheckboxButton usePriority = new CheckboxButton(getNeighbourX(shouldFuse), getRowY(2), 20 + font.getStringWidth("Using priority"), 20, "Using priority", false);
    public CheckboxButton needRedstone = new CheckboxButton(getNeighbourX(useDelay), getRowY(3), 20 + font.getStringWidth("Needs redstone"), 20, "Needs redstone", false);
